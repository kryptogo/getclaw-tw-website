...
我舉了清大資工書卷獎小畢（Marcus）的例子——他做了一個 AI 每天自動搜尋熱門新聞、錄成 Podcast 讓他通勤時聽的系統。看起來酷炫，但 setup 花了三到五天。因為背後要問很多問題：什麼叫「最熱門」？你關注什麼領域？Podcast 喜歡什麼長度？通勤多久？每一個都很客製化。

如芬不認同 command line 是「low-end」：「我們不是覺得它低階，是不熟悉。但最有效率的方式就是要熟悉。」
