...
const painPoints = [
  {
    ...
    insight: "KOL 講得很炫砲，但他們要的是點閱，不是幫你解決問題",
    delay: 0,
  },
  {
    layer: "第二層",
    pain: "不知道 AI 能幫我做什麼——缺的是想像力，不是工具",
    solution: "我們到場觀察你的工作流程，幫你發現「原來這個也能自動化」的場景",
    insight: "設定永遠是最簡單的，最難的是到底要解決什麼問題",
    delay: 0.1,
  },
  {
    layer: "第三層",
    pain: "AI 不懂我——同樣的模型，每個人用出來結果不一樣",
    solution: "幫你建立個人知識庫，讓 AI 累積 Context，越用越懂你的業務與風格",
    insight: "AI 是放大器：你的基礎能力決定了 AI 能幫你放大到什麼程度",
    delay: 0.2,
  },
];
