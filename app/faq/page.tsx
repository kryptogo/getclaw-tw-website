...
const faqs = [
  ...
  {
    q: "部署包含什麼？",
    a: "完整部署包括：軟體安裝 + 安全加固 + Email/Calendar/通訊軟體整合 + 最多 3 個關鍵工作流程設定 + 完整文件交付 + 14 天 hypercare 支援。",
  },
  {
    q: "部署要多久？",
  ...
  {
    q: "安全嗎？",
    a: "非常安全。你的資料完全在你的機器上處理，不經過任何第三方雲端。我們遵循官方 hardening guide 進行完整安全加固，部署結果能通過企業資安審查。",
  },
  {
    q: "可以整合 LINE 嗎？",
  ...
  {
    q: "14 天之後呢？",
    a: "14 天 hypercare 結束後，你可以選擇我們的 Managed Care 月費方案（持續監控、支援、更新），或者自行維護。我們會交付完整文件，確保你有能力自行管理。",
  },
  {
    q: "可以幫整個團隊部署嗎？",
    a: "這是最常見的情境。大多數 5–50 人的團隊會部署 2–4 個 Agent。我們會在 Kickoff 時幫你決定角色分配，例如 CEO Agent、CFO Agent、Sales Agent、EA Agent。",
  },
  {
    q: "需要什麼硬體？",
